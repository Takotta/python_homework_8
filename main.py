...
file_path = r'C:\Users\Ekaterina\Desktop\Python_Homework\phonebook.txt'
...
while True:
    p = input(
        'Введите : 1 - для создания пустого справочника, 2 - для добавления строки, 3 для изменения/удаления строки, 4 - для поиска по номеру или имени, 5 - для вывода всего справочника. ')
    if p == '1':
        create_phonebook()
    elif p == '2':
        add_number()
